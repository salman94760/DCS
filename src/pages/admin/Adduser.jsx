          ...
          <div>
             ...
             <div>
              ...
              <div class="relative">
                ...
                <textarea className="w-full pl-9 pr-4 py-2.5 text-sm border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-200" name="address"></textarea>
