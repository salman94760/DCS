    ...
    <div class="bg-[#0a1122] min-h-screen relative overflow-hidden flex items-center justify-center px-4">
      ...
      <div class="relative z-10 w-full max-w-lg text-center">
        <div class="flex flex-col items-center mb-8">
          <img src="/logo.png" />
          <p class="text-white font-extrabold text-base tracking-wide text-center">
        ...
        <div class="relative w-40 h-40 mx-auto mb-8">
          <svg
            class="gear-1 absolute top-0 left-4 w-24 h-24 text-blue-500"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
          ...
          <svg
            class="gear-2 absolute bottom-0 right-2 w-16 h-16 text-blue-300"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
        ...
        <p class="text-slate-400 text-sm max-w-md mx-auto leading-relaxed mb-8">
          Our compliance dashboard is currently undergoing scheduled maintenance
          to bring you a better experience. We appreciate your patience and will
          be back online shortly.
        </p>

        <p class="text-slate-600 text-xs mt-4">
          © 2026 Dot Compliance Solutions LLC
        </p>
      </div>
    </div>
  );
